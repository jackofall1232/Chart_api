...
def chart():
    ...
    try:
        ...
        # Ensure enough data for rolling calculations (minimum 20 points)
        if len(df) < 20:
            return "Error: Insufficient data (need at least 20 points for Bollinger Bands)", 400
        ...
        if os.path.exists(logo_path):
            try:
                ...
                print(f"Logo loaded, shape: {img.shape}")
